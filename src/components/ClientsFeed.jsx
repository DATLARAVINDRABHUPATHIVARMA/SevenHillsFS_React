...
const reviews = [
  ...
  },
  {
    ...
    review:
      "Reliable and efficient service. They truly understand our needs and exceed expectations.",
  },
  {
    id: 7,
    name: "Lisa Anderson",
    ...
    review:
      "Excellent customer service and attention to detail. They go above and beyond to ensure our satisfaction.",
  },
  {
    id: 8,
    name: "Robert Taylor",
    ...
    review:
      "Impressive results and outstanding professionalism. A true partner in our success.",
  },
  {
    id: 9,
    ...
    review:
      "Their team is responsive, reliable, and always delivers high-quality work. We are extremely satisfied with their services.",
  },
];
    ...
    <div className="py-20 bg-gray-100">
      <div>
        ...
        <p className="text-center text-gray-600 mb-12">
          ...
          working with Seven Hills Facility Services.
        </p>
      </div>
      <Swiper
