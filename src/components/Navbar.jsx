...
const Navbar = () => {
  ...
  const handleEmailClick = () => {
    window.location.href = "mailto:hr@sevenhillsfs.com";
  };

  const handlePhoneClick = () => {
    window.location.href = "tel:+914035511829";
  };
        ...
        <div className="flex items-center justify-between h-[72px] xl:h-[78px]">
          ...
          <div className="hidden xl:flex flex-1 ml-6 flex-col justify-center">
            <div className="flex justify-end items-center text-[15px] pb-1">
              ...
              <div 
                className="flex items-center gap-2 ml-6 cursor-pointer transition-colors duration-300 group"
            ...
            <div className="flex items-center justify-between border-t border-gray-300 pt-1.5">
              ...
              >
                <button className="menu-btn">
                  About Us
                  <FaChevronDown className={`ml-1 text-[11px] transition duration-300 ${ activeDropdown === "about" ? "rotate-180" : "" }`}/>
                </button>
              ...
              >
                <button className="menu-btn">
                  Industries
                  <FaChevronDown className={`ml-1 text-[11px] transition duration-300 ${ activeDropdown === "industries" ? "rotate-180" : "" }`}/>
                </button>
              ...
              >
                <button className="menu-btn">
                  Services
                  <FaChevronDown className={`ml-1 text-[11px] transition duration-300 ${ activeDropdown === "services" ? "rotate-180" : "" }`}/>
                </button>
              ...
              >
                <button className="menu-btn">
                  Locations
                  <FaChevronDown className={`ml-1 text-[11px] transition duration-300 ${ activeDropdown === "locations" ? "rotate-180" : "" }`}/>
                </button>
        ...
        <div className="xl:hidden bg-white border-t border-gray-200 shadow-md">
          <div className="px-5 py-5 flex flex-col space-y-4 max-h-[85vh] overflow-y-auto">
            <div className="border-b border-gray-200 pb-4 space-y-3">
              <div 
                className="flex items-center gap-3 cursor-pointer transition-colors duration-300 group"
                onClick={handleEmailClick}
              >
