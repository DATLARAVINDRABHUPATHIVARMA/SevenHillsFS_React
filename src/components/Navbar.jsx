  ...
  return (
    <div className="bg-white shadow-md border-b border-gray-200 sticky top-0 z-50">
        ...
        <div className="flex items-center justify-between h-[72px] lg:h-[78px]">
          ...
          <div className="hidden lg:flex flex-1 ml-6 flex-col justify-center">
            <div className="flex justify-end items-center text-[13px] pb-1">
              <div 
                className="flex items-center gap-2 cursor-pointer hover:text-sky-500 transition-colors duration-300"
              ...
              <div 
                className="flex items-center gap-2 ml-6 cursor-pointer hover:text-sky-500 transition-colors duration-300"
        ...
        <div className="lg:hidden bg-white border-t border-gray-200 shadow-md">
          <div className="px-5 py-5 flex flex-col space-y-4 max-h-[85vh] overflow-y-auto">
            <div className="border-b border-gray-200 pb-4 space-y-3">
              <div 
                className="flex items-center gap-3 cursor-pointer hover:text-sky-500 transition-colors duration-300"
                onClick={handleEmailClick}
              >
      ...
      <style jsx>{` 
        ...
        .mobile-link:hover { color: #0284c7; }
        ...
        .mobile-dropdown-btn:hover { color: #0284c7; }
