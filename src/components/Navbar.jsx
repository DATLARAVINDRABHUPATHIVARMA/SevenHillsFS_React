  ...
  return (
    <div className="bg-white border-b border-b-gray-200">
      <div className="flex justify-between items-center max-w-7xl mx-auto px-4 lg:px-0">
        ...
        <div className="">
          ...
          <div className="hidden lg:flex items-center space-x-4 border-t border-t-gray-300 py-2">
            ...
            <div className="group">
              <a
                href=""
                className="flex items-center space-x-1 font-medium px-3"
              >
                <span>About Us</span>
        ...
        <div className="">
          <button className="px-5 py-2 hidden lg:block bg-sky-500 text-white rounded-full hover:bg-sky-600 cursor-pointer">
            Get a Quote
          </button>
          <button
