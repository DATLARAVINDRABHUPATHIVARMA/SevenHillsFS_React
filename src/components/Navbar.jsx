      ...
      {mobileMenu && (
        <div className={`${mobileMenu ? 'block' : 'hidden'} lg:hidden`}>
          <div className='py-3 flex flex-col space-y-2 max-h-[80vh] pl-4 overflow-y-auto'>
            ...
            <div>
              <button onClick={() => setIndustriesDropdown(!industriesDropdown)} className='flex items-center'>
                <span>Industries</span>
                <FaChevronDown className='text-xs ml-2'/>
              </button>
              {industriesDropdown && (
            ...
            <div>
              <button onClick={() => setServicesDropdown(!servicesDropdown)} className='flex items-center'>
                <span>Services</span>
                <FaChevronDown className='text-xs ml-2'/>
              </button>
              {servicesDropdown && (
            ...
            <div>
              <button onClick={() => setLocationsDropdown(!locationsDropdown)} className='flex items-center'>
                <span>Locations</span>
                <FaChevronDown className='text-xs ml-2'/>
              </button>
              {locationsDropdown && (
